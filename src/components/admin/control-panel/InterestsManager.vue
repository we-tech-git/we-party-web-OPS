    ...
    <section v-if="activeTab === 'active'" class="tab-content">
      ...
      <div class="interests-grid">
        ...
        >
          ...
          <div
            class="interest-trend"
            :class="interest.trend > 0 ? 'interest-trend--up' : 'interest-trend--down'"
          >
        ...
        <div class="analytics-card">
          ...
          <div class="growth-list">
            <div v-for="item in growthData" :key="item.name" class="growth-item">
              ...
              <div
                class="growth-change"
                :class="item.trend > 0 ? 'growth-change--up' : 'growth-change--down'"
              >
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select v-model="modalCategory" class="form-select">
        ...
        <div class="modal-actions">
          ...
          <button
            ...
            :disabled="!modalInterestName.trim()"
            type="button"
            @click="saveInterest"
          >
            {{ editingIndex !== null ? t('admin.interestsManager.save') : t('admin.interestsManager.add') }}
          </button>
        </div>
      </div>
    </div>
...
<script setup lang="ts">
  ...
  const interests = ref<Interest[]>([
    { name: 'ROCK', category: 'music', eventsCount: 45, usersCount: 2340, trend: 12 },
    { name: 'FUNK', category: 'music', eventsCount: 38, usersCount: 1890, trend: 8 },
    { name: 'ELETRÔNICA', category: 'music', eventsCount: 32, usersCount: 1567, trend: 15 },
    { name: 'REGGAE', category: 'music', eventsCount: 18, usersCount: 890, trend: -3 },
    { name: 'SERTANEJO', category: 'music', eventsCount: 28, usersCount: 1450, trend: 5 },
    { name: 'PALESTRA', category: 'culture', eventsCount: 22, usersCount: 1120, trend: 20 },
    { name: 'STAND UP', category: 'culture', eventsCount: 15, usersCount: 780, trend: 10 },
    { name: 'GASTRONOMIA', category: 'food', eventsCount: 12, usersCount: 650, trend: 25 },
    { name: 'ESPORTES', category: 'sports', eventsCount: 8, usersCount: 420, trend: -5 },
    { name: 'TECNOLOGIA', category: 'tech', eventsCount: 10, usersCount: 560, trend: 18 },
  ])
  ...
  function saveInterest () {
    ...
    if (editingIndex.value === null) {
      interests.value.push({
        name: modalInterestName.value.toUpperCase(),
